...
const emit = defineEmits(["deleteModule"]);
...
const handleDeleteModule = async () => {
  try {
    await fetchy(`/api/modules/${props.module._id}`, "DELETE");
    emit("deleteModule");
...
<template>
  <main>
    <div @click="clickButton">Delete</div>
    <div class="modal-background" v-if="isButtonClicked">
      <div class="modal-content">
        <form @submit.prevent="handleDeleteModule()">
          <div class="text">
            <h3>Are you sure you want to delete this module?</h3>
            <p>All of its associated posts will be permanently deleted.</p>
          </div>
