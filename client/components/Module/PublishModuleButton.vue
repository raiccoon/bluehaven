...
<template>
  <main>
    <div v-if="props.module.hidden" @click="clickButton">Publish</div>
    <div v-else @click="clickButton">Hide</div>
    <div class="modal-background" v-if="isButtonClicked">
      <div class="modal-content">
        <form @submit.prevent="toggleModuleVisibility()">
          <div class="text">
            <h3 v-if="props.module.hidden">Are you sure you want to publish this module?</h3>
            <h3 v-else>Are you sure you want to hide this module?</h3>
            <p v-if="props.module.hidden">Published modules are visible to all students in the class.</p>
          </div>
